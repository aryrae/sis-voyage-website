...
export const metadata: Metadata = {
  ...
  description:
    "SIS Voyage is a full-service travel agency specialising in group, mission, heritage, wedding, corporate and bespoke travel — bilingual EN/FR, veteran-owned, Fora-credentialed.",
  keywords: [
    "travel agency",
    "Christian travel",
    "Holy Land tours",
