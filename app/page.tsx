  ...
  return (
    <>
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-3">
            ...
            <h1 className="font-[var(--font-display)] text-4xl sm:text-5xl lg:text-6xl leading-tight text-[var(--color-ink-900)]">
              Travel done with care. Discipline. Efficiency.
            </h1>
      ...
      <footer className="max-w-6xl mx-auto px-4 sm:px-6 py-12 border-t border-[var(--color-ink-900)]/8 mt-12">
        ...
        {/* Credentials */}
        <div className="mt-10 pt-8 border-t border-[var(--color-ink-900)]/8">
          <div className="text-xs uppercase tracking-wider text-[var(--color-amber-deep)] font-semibold mb-5 text-center">
            Credentials &amp; certifications
          </div>
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            {/* Texas Veteran-Owned Business */}
            <div className="glass rounded-2xl px-4 py-3 flex items-center gap-3 min-w-0">
              <div className="w-11 h-11 rounded-xl bg-[var(--color-rose)]/15 flex items-center justify-center text-[var(--color-rose-deep)] shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
              </div>
              <div className="min-w-0">
                <div className="text-sm font-semibold text-[var(--color-ink-900)]">Texas Veteran-Owned</div>
                <div className="text-[10px] text-[var(--color-ink-500)]">Certified by Texas Veterans Commission</div>
              </div>
            </div>

            {/* SDVOSB */}
            <div className="glass rounded-2xl px-4 py-3 flex items-center gap-3 min-w-0">
              <div className="w-11 h-11 rounded-xl bg-[var(--color-amber-brand)]/15 flex items-center justify-center text-[var(--color-amber-deep)] shrink-0">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-1 6h2v2h-2V7zm0 4h2v6h-2v-6z"/>
                </svg>
              </div>
              <div className="min-w-0">
                <div className="text-sm font-semibold text-[var(--color-ink-900)]">SDVOSB</div>
                <div className="text-[10px] text-[var(--color-ink-500)]">Service-Disabled Veteran-Owned Small Business · Federal</div>
              </div>
            </div>

            {/* Fora / IATA */}
            <div className="glass rounded-2xl px-4 py-3 flex items-center gap-3 min-w-0">
              <div className="w-11 h-11 rounded-xl bg-[var(--color-sage)]/15 flex items-center justify-center text-[var(--color-sage-deep)] shrink-0">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
              </div>
              <div className="min-w-0">
                <div className="text-sm font-semibold text-[var(--color-ink-900)]">IATA-Accredited</div>
                <div className="text-[10px] text-[var(--color-ink-500)]">via Fora Travel · IATA #[pending]</div>
              </div>
            </div>
          </div>
          <div className="text-[10px] text-[var(--color-ink-500)] mt-5 text-center max-w-xl mx-auto leading-relaxed">
            Certifications verified by the Texas Veterans Commission, the U.S. Small Business
            Administration&apos;s Veteran Small Business Certification program, and the International
            Air Transport Association. Official registration numbers and certificate copies
